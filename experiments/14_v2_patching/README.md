...
**Date:** 2026-02-25
**Model:** llama1b_base (Llama-3.2-1B-Instruct, HF on MPS)
**Probe layers:** [2, 5, 7, 9, 10, 11, 12, 14]
...
- `outputs/patching_results_llama1b_base_{seta,setb}_{h,a,m}.csv`
- `outputs/patching_success_by_layer_*.csv`
- `outputs/patching_crossset_results_llama1b_base_*.csv`
- `outputs/patching_heatmap_llama1b_base.png/.svg`
- `outputs/patching_crossset_llama1b_base.png/.svg`
