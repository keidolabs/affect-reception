"""
Experiment 07 — Phase 1: Activation Extraction
...
Uses HF transformers + MPS — same method as Phase 0b (02_phase0b_llama3-8b-instruct).

Estimated time: ~6-15 min on MPS
Run: uv run python experiments/07_phase1_llama3-8b-instruct/extract.py
"""
