"""
Experiment 06 — Phase 1: Probes + Geometry (Llama-3-8B base, Set B)
Date: 2026-02-24
...
MODEL_COLOR  = "#3498db"   # blue — matches Phase 0 comparison chart
MODEL_LABEL  = "Llama-3-8B (base)"

# Path to the corresponding Phase 0 results for comparison
PHASE0_RESULTS = Path(__file__).parent.parent / "01_phase0a_llama3-8b" / "outputs" / "results.csv"
