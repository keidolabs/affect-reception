"""
Experiment 06 — Phase 1: Activation Extraction
Model: meta-llama/Meta-Llama-3-8B (32 layers, d_model=4096)
Date: 2026-02-24

Extracts final-token residual stream at all 32 layers for all 192 Set B stimuli
(96 clinical vignettes + 96 matched neutral controls).
Output shape: (192, 32, 4096)

Uses HF transformers + MPS — same method as Phase 0a (01_phase0a_llama3-8b).

Estimated time: ~6-15 min on MPS (192 stimuli vs 90 in Phase 0)
Run: uv run python experiments/06_phase1_llama3-8b/extract.py
"""
...
console.print("  Model is already cached from Phase 0 — loading from disk only")
