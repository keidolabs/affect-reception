"""
Experiment 12 — v2 Set B Extraction: Meta-Llama-3-8B (base)
Date: 2026-02-25
Framework: HF transformers + register_forward_hook on MPS
Run: uv run python experiments/12_v2_extract_setb/extract_llama8b_base.py
"""
...
EMOTION_VOCAB = {
    ...
    "loathing": [" disgust", " loathing", "disgust"], "amazement": [" surprise", " amazement"],
    "admiration": [" admiration", " respect"], "vigilance": [" anxiety", " vigilance"],
}
...
console.print(f"Set B: {len(all_stimuli)} stimuli"); assert len(all_stimuli) == 192
