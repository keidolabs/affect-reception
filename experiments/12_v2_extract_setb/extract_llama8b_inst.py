"""
Experiment 12 — v2 Set B Extraction: Meta-Llama-3-8B-Instruct
Date: 2026-02-25
Framework: HF transformers + register_forward_hook on MPS
Run: uv run python experiments/12_v2_extract_setb/extract_llama8b_inst.py
"""
...
MODEL_KEY = "llama8b_inst"; MODEL_ID = "meta-llama/Meta-Llama-3-8B-Instruct"
...
for p, acc in [("The capital of France is", ["Paris", " Paris"])]:
    ...
    if not any(t in top3 for t in acc): raise RuntimeError("MPS validation FAILED")
