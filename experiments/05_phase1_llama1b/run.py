"""
Experiment 05 — Phase 1: Probes + Geometry (Llama-3.2-1B, Set B)
Date: 2026-02-24
...
MODEL_COLOR  = "#95a5a6"   # gray — matches Phase 0 comparison chart
MODEL_LABEL  = "Llama-3.2-1B"

# Path to the corresponding Phase 0 results for comparison
PHASE0_RESULTS = Path(__file__).parent.parent / "00_phase0_replication" / "outputs" / "results.csv"
