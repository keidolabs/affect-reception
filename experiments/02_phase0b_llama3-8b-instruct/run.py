"""
Experiment 02 — Phase 0b: Layer-wise Probes + Geometry
...
Run: uv run python experiments/02_phase0b_llama3-8b-instruct/run.py
"""
...
ax.set_title(f"Phase 0b: Layer-wise Probe — {MODEL_ID}\nSet A (n=80 emotional), 8-class OvR, 5-fold CV")
