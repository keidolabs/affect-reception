"""
Experiment 02 — Phase 0b: Activation Extraction
...
Run: uv run python experiments/02_phase0b_llama3-8b-instruct/extract.py
"""
...
# We probe raw residual stream activations — the Instruct fine-tuning shifts
# internal representations but does not change the architecture, so extraction
# logic is identical to the base model (Phase 0a).
...
# ============================================================================
# The Instruct model is chat-tuned, so it may handle bare completions
# differently than the base model. We use prompts that any competent model
# should complete correctly regardless of instruction-tuning.
