"""
Experiment 08 — Phase 1: Probes + Geometry (Gemma-2-9B, Set B)
Date: 2026-02-24
...
MODEL_COLOR  = "#9b59b6"   # purple — matches Phase 0 comparison chart
MODEL_LABEL  = "Gemma-2-9B"

# Path to the corresponding Phase 0 results for comparison
PHASE0_RESULTS = Path(__file__).parent.parent / "03_phase0c_gemma2-9b" / "outputs" / "results.csv"
